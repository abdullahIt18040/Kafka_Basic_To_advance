...
✅ ধাপ ৫️⃣: ক্লাস্টারে নতুন ব্রোকার যোগ হয়েছে কিনা যাচাই করো
...
.\bin\windows\kafka-metadata-shell.bat --snapshot <path_to_your_metadata_snapshot>


👉 এখানে broker.id=4 দেখা গেলে বুঝবে ব্রোকার সফলভাবে যুক্ত হয়েছে।
